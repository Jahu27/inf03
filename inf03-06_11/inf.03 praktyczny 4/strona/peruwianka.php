...
<body>
    <div id="body">
        ...
        <div id ="lbmain">
            <img src="peruwianka.jpg" alt="Świnka morska rasy peruwianka"></img>
            <?php 
               $data =  executeQuerry("SELECT DISTINCT swinki.data_ur,swinki.miot, rasy.rasa from swinki INNER JOIN rasy on swinki.rasy_id = rasy.id where rasy_id = 1");
            ...
            <?php
                $data = executeQuerry("SELECT swinki.imie , swinki.cena , swinki.opis from swinki INNER JOIN rasy on rasy.id = swinki.rasy_id where rasy.id = 1;");
                $r = "";
                foreach($data as $row){
